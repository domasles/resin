...
static mp_obj_t resin_hw_init_screen(void) {
    rh_display_init();
    rh_dma_init();
    rh_input_init();
    rh_cdc_init();
...
static MP_DEFINE_CONST_FUN_OBJ_0(resin_hw_init_screen_obj, resin_hw_init_screen);
...
static const mp_rom_map_elem_t resin_hw_module_globals_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_init_screen), MP_ROM_PTR(&resin_hw_init_screen_obj)},
